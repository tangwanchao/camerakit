...
public class Camera1 extends CameraImpl {
    ...
    Size getPreviewResolution() {
        ...
        boolean invertPreviewSizes = (mCameraInfo.orientation) % 180 == 90;
    ...
    private void adjustCameraParameters(int currentTry) {
        ...
        Size resolution = getPreviewResolution();
        if (resolution != null) {
            ...
            for (Camera.Size supportedPreviewSize : resolutionLess.getSupportedPreviewSizes()) {
                if (supportedPreviewSize.width == resolution.getWidth() && supportedPreviewSize.height == resolution.getHeight()) {
